...
class BottlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bottle" do
    assert_difference('Bottle.count') do
      post bottles_url, params: { bottle: { material: @bottle.material, price: @bottle.price, size: @bottle.size } }
    end
  ...
  test "should update bottle" do
    patch bottle_url(@bottle), params: { bottle: { material: @bottle.material, price: @bottle.price, size: @bottle.size } }
